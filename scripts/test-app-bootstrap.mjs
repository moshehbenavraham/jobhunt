...
const currentSessionId = 'phase01-session03-agent-runtime-bootstrap';
...
function createStoredAuthRecord() {
  return `${JSON.stringify(
    {
      credentials: {
        accessToken: 'fixture-access-token-bootstrap',
        accountId: 'acct-bootstrap-smoke',
        expiresAt: Date.now() + 60_000,
        refreshToken: 'fixture-refresh-token-bootstrap',
      },
