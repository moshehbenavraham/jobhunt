...
// -- 3ag. App tracker-workspace smoke ----------------------------

console.log("\n3ag. App tracker-workspace smoke");

const appTrackerWorkspace = run("node", [
	"scripts/test-app-tracker-workspace.mjs",
]);
if (appTrackerWorkspace !== null) {
	pass("App tracker-workspace smoke tests pass");
} else {
...
const bootstrapFiles = [
	...
	"apps/api/src/server/research-specialist-contract.ts",
	...
	"apps/api/src/server/tracker-specialist-summary.test.ts",
	...
	"apps/api/src/tools/research-specialist-tools.test.ts",
