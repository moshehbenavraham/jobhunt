...
| `modes/scan.md`                                      | Scan workflow still uses `WebSearch`, `WebFetch`, `browser_navigate`, `browser_snapshot`, and `/career-ops pipeline` wording | Phase 03     | Scanner prompt normalization is out of scope for Phase 01 docs closeout             |
| `modes/apply.md` and `modes/followup.md`             | Next-step guidance still uses `/career-ops ...` slash-command wording                                                        | Phase 03     | Workflow wording normalization belongs to the prompt cleanup phase                  |
| `scripts/scan.mjs`                                   | User-facing output still says `Run /career-ops pipeline`                                                                     | Phase 03     | Runtime wording cleanup for helper output is not part of this docs sweep            |
