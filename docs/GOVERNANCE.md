...
- **Architecture decisions** (docs/CLAUDE.md, scoring system, data contract) — maintainer only
...
4. **Understand the project** — read docs/CLAUDE.md, docs/DATA_CONTRACT.md, the architecture docs
