...
Instead, please email **max@aiwithapex.com** with:
...
- **Scripts** (`scripts/*.mjs`) — command injection, path traversal, SSRF
...
- jobhunt is a local tool — there is no hosted service to attack
