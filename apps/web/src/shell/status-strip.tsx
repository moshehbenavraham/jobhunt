...
function getFallbackSummary(status: OperatorShellViewStatus): {
  ...
  switch (status) {
    case 'loading':
      return {
        body: 'Reading readiness, approvals, and runtime activity from the local API.',
        title: 'Loading operator shell',
      };
    case 'offline':
      return {
    ...
    case 'error':
      return {
        body: 'The shell summary failed before it could render the live status cards.',
        ...
        <article style={cardStyle}>
          ...
          <p style={{ marginBottom: '0.35rem' }}>
            {summary.activity.activeSession
              ...
              : 'No running or waiting runtime session is attached to the shell yet.'}
          </p>
          <p style={{ color: '#475569', marginBottom: 0 }}>
