		...
		<section style={panelStyle}>
			...
			<div style={cardGridStyle}>
				<article style={cardStyle}>
					<h2 style={{ marginTop: 0 }}>Health overview</h2>
					<p>
						<span
							style={{
								...healthBadgeStyle,
					...
					<p style={{ marginBottom: "0.4rem" }}>
						Health paths: <code>{diagnostics.bootSurface.healthPath}</code> and{" "}
				...
				<article style={cardStyle}>
					<h2 style={{ marginTop: 0 }}>Repo configuration</h2>
					<p style={{ marginBottom: "0.4rem" }}>
				...
				<article style={cardStyle}>
					<h2 style={{ marginTop: 0 }}>Prompt configuration</h2>
					<p style={{ marginBottom: "0.4rem" }}>
