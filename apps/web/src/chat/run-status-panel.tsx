...
function resolveEvaluationDisplay(
  payload: EvaluationResultSummaryPayload,
): {
  ...
  const sessionId = summary.session?.sessionId ?? payload.filters.sessionId ?? null;
...
export function RunStatusPanel({
  ...
  return (
    ...
    >
      ...
      {display.focus && display.buttonLabel ? (
        <button
          aria-label={display.buttonLabel}
          disabled={isBusy}
          onClick={() => onOpenApprovals(display.focus!)}
          style={{
            ...buttonStyle,
