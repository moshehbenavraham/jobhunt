	...
	return (
		<section aria-labelledby="settings-runtime-title" style={cardStyle}>
			<header>
				...
				<h2 id="settings-runtime-title" style={{ marginBottom: "0.35rem" }}>
					Readiness and app-first landing
				</h2>
			...
			>
				...
				<p style={{ color: "#475569", marginBottom: 0, marginTop: "0.35rem" }}>
					{tone.phaseReady
						? `${phaseLabel} is ready for the operator home and app shell to stay primary, while the dashboard and Codex remain secondary paths.`
						: `${phaseLabel} still depends on runtime or onboarding follow-up before the operator home can stay primary.`}
				</p>
			</section>
