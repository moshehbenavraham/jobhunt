...
export function BatchDetailPage() {
	...
	if (!batchId || batchId.trim() === "") {
		return (
			<section style={pageStyle}>
				<header>
					<p style={labelSmStyle}>Batch detail</p>
					<h2 style={{ ...headingStyle, fontFamily: "var(--jh-font-heading)" }}>
						No batch specified
					</h2>
				</header>
				<p style={bodySecondaryStyle}>
					No batch identifier was provided. Navigate to batch to pick one.
				</p>
				<Link style={actionLinkStyle} to="/batch">
					Back to batch
				</Link>
			</section>
		);
	...
	return (
		<section aria-labelledby="batch-detail-heading" style={pageStyle}>
			<header style={{ display: "grid", gap: "var(--jh-space-1)" }}>
				<p style={labelSmStyle}>Batch detail</p>
				<h2 id="batch-detail-heading" style={headingStyle}>
					{batchId}
				</h2>
				<Link style={backLinkStyle} to="/batch">
					Back to batch
				</Link>
			</header>
			...
			<section style={cardStyle}>
				<p style={bodySecondaryStyle}>
					Batch details will appear here once data loading is wired up.
				</p>
			</section>
		</section>
	);
