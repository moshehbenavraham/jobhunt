...
export type SettingsMaintenanceCommandCategory =
  'auth' | 'backup' | 'diagnostics' | 'updates';
  ...
  return [
    {
      ...
      description:
        'Validate the app-first runtime prerequisites, auth readiness, and required user-layer files.',
      id: 'doctor',
      label: 'Run doctor',
    },
    {
    ...
    },
    {
      ...
      description:
        'Create the stored OpenAI account auth state used by the app-owned runtime and repo-owned workflows.',
      id: 'auth-login',
      label: 'Auth login',
    },
    {
    ...
    },
    {
      ...
      description:
        'Apply the latest repo-managed update after reviewing the scope in the terminal.',
      id: 'update-apply',
      label: 'Apply update',
    },
    {
