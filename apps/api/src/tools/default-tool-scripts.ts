...
const DEFAULT_SESSION04_TOOL_SCRIPTS = [
	{
		...
		commandArgs: ["scripts/analyze-patterns.mjs"],
		description:
			"Analyze saved tracker and report history to extract rejection patterns and recommended score thresholds.",
		name: "analyze-patterns",
		successExitCodes: [0, 1],
		timeoutMs: DEFAULT_TOOL_SCRIPT_TIMEOUT_MS["analyze-patterns"],
	},
	{
		command: process.execPath,
	...
	{
		command: process.execPath,
		commandArgs: ["scripts/followup-cadence.mjs"],
		description:
			"Analyze tracker and follow-up history to stage overdue, urgent, and waiting follow-up guidance.",
		name: "followup-cadence",
		successExitCodes: [0, 1],
		timeoutMs: DEFAULT_TOOL_SCRIPT_TIMEOUT_MS["followup-cadence"],
	},
	{
		command: process.execPath,
